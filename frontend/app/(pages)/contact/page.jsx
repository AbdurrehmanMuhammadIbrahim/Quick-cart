  ...
  return (
    <div>
       <div className="font-[sans-serif] max-w-6xl mx-auto p-4">
        <div className='text-3xl font-semibold text-center underline my-5'> Contact Us </div>
      <div className="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-8 border border-[#FF7518] rounded-lg border-b-4 border-r-4">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="flex flex-col items-center bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#FF7518]" viewBox="0 0 512 512">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-sm text-gray-500 mt-2"> 123 Main Street, City, Country</p>
            </div>
          </div>

          <div className="flex flex-col items-center bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#FF7518]" viewBox="0 0 473.806 473.806">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-sm text-gray-500 mt-2"> +92 123456789</p>
            </div>
          </div>

          <div className="flex flex-col items-center bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#FF7518]" viewBox="0 0 32 32">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-sm text-gray-500 mt-2">miabdurrehman@gmail.com</p>
            </div>
          </div>

          <div className="flex flex-col items-center bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#FF7518]" viewBox="0 0 100 100">
        ...
        <form className="mt-12 space-y-3 max-w-xl mx-auto text-gray-800">
          <input type='text' placeholder='Name'
            className="w-full border rounded py-3 px-4 text-sm focus:outline-[#FF7518]" />
          <input type='email' placeholder='Email'
            className="w-full border rounded py-3 px-4 text-sm focus:outline-[#FF7518]" />
          <input type='email' placeholder='Phone No.'
            className="w-full border rounded py-3 px-4 text-sm focus:outline-[#FF7518]" />
          <textarea placeholder='Message' rows="6"
            className="w-full border rounded px-4 text-sm pt-3 focus:outline-[#FF7518]"></textarea>
          <button type='button'
            className="text-white w-full bg-[#FF7518] hover:bg-blue-700 rounded text-sm px-6 py-3 !mt-6">
