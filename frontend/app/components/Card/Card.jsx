  ...
  return (
    ...
    <div className="p-4 max-w-64 ">
        <div className="flex rounded-lg  dark:bg-gray-800  border border-b-4 border-r-4 border-orange-500 p-4 flex-col">
            ...
            <div className="flex items-center mb-3 max-w-xs">
                <h2 className="mt-2 dark:text-white text-lg font-medium text-ellipsis  whitespace-nowrap overflow-hidden">{props.title}</h2>
            </div>
