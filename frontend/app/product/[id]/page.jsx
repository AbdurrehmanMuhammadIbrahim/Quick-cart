        ...
        <div className="lg:max-w-6xl max-w-xl mx-auto">
          <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
            ...
            <div className="w-full">
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-800">{singleProduct.title}</h3>
              ...
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-4">
                  ...
                  <button type="button" className="px-4 py-3 w-[45%] border border-[#FF7518] bg-[#FF7518] hover:bg-white  text-white hover:text-black-500 text-sm font-semibold">Buy it now</button>
                </div>
              </div>
